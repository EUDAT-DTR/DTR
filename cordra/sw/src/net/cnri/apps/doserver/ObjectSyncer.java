...
//  public ObjectSyncer(Main m, Storage storage) 
//    throws Exception
//  {
//    mainServer = m;
//    mainStorage = storage;
...
//              if(DEBUG) System.err.println("pushing transactions since: "+lastTime+" to "+server);
//              
//              Enumeration txnEnum = mainServer.getTxnQueue().getScanner(lastTime);
//              if(txnEnum.hasMoreElements()) {
//                if(DEBUG) System.err.println("there are transactions to push...");
//                
...
//                  if(DEBUG) {
//                    System.err.println("  sending txn with timestamp: "+
//                                       txn.timestamp+
...
//                      System.err.println("transaction "+txn+" being ignored - out of date");
//                      writeData = false;
//                    } else {
//                      throw e;
//                    }
...
//              System.err.println("Error pushing changes to "+server+": "+e);
//              System.err.println("Will try the next server...");
...
//          }
//        } catch (Throwable t) {
//          System.err.println("Error attempting push replication: "+t);
//          System.err.println("Will try again soon");
//        }
//      }
//    }
//  }
...
//                }
//                if(DEBUG) {
//                  System.err.println("Replicating with server "+serverID+
//                                     "; status="+serverStatus);
//                }
//                
...
//                
//              } catch (Exception e) {
//                System.err.println("Error replicating with server: "+server+"; error: "+e);
...
//          } catch (Throwable t) {
//            System.err.println("Replication Error: "+t);
...
//    } catch (Throwable t) {
//      System.err.println("Unable to save replication status!\n  "+t);
//      t.printStackTrace(System.err);
//    }
//  }
//  
...
//    
//    if(DEBUG) System.err.print(">>>transaction: "+record);
//    
...
//              } catch (Exception e) {
//                System.err.println("Invalid timestamp: obj="+objID+"; element="+tag+"; val="+val);
//                continue;
//              }
...
//        if(!metadata.objectExists() && metadata.getDateDeleted()<timestamp) {
...
//          System.err.println("Received outdated element-updated transaction during "+
...
//          } else {
//            System.err.println("Unable to replicate element "+elementID+" from object "+objID+"  code: "+doError.getErrorCode());
//            throw doError;
//          }
//        }
//        
...
//        if(oldTimestamp>timestamp) {
//          // there is already a newer version of the data element on this server
//          System.err.println("Received outdated element-removed transaction during "+
//                             "replication: object="+objID+"; element="+elementID+";");
//          return;
//        }
//        
//        metadata.setTag(mdTagName, String.valueOf(timestamp));
//        mainStorage.deleteDataElement(objID, elementID, false);
//        metadata.updateModification(timestamp);
//        mainStorage.setObjectInfo(metadata);
//        
//      } else if(txnType.equals(TXN_TYPE_COMMENT)) {
//        System.err.println("Received comment replication record: "+record);
//      } else {
//        throw new DOException(DOException.REPLICATION_ERROR,
...
//      default:
//        System.err.println("Error: Ignoring unknown transaction type in txn log: "+((int)txnAction));
//        return ReplicationManager.TXN_TYPE_COMMENT;
//    }
//  }
//  
