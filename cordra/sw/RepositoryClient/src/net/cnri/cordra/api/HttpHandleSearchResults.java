...
public class HttpHandleSearchResults implements SearchResults<String> {
    ...
    public HttpHandleSearchResults(CloseableHttpResponse response) throws CordraException {
        try {
