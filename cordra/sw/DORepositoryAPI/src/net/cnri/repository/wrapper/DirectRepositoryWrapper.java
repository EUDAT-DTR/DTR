...
/**
 * A wrapper class for wrapping a {@link Repository} as a {@link DirectRepository}.  Can be used to convert any Repository into a DirectRepository,
 * or to add functionality to an existing DirectRepository.
 */
public class DirectRepositoryWrapper extends RepositoryWrapper implements DirectRepository {
    ...
    public File getFile(String handle, String elementName) throws RepositoryException {
        ...
        if(el instanceof DataElementWrapper && ((DataElementWrapper) el).originalDataElement instanceof FileDataElement) {
            return ((FileDataElement)((DataElementWrapper) el).originalDataElement).getFile(); 
        }
